    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mb-6 pb-4 border-b border-white/10 flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex min-w-0 max-w-full items-center gap-1.5 sm:gap-2 bg-neutral-900/90 border border-neutral-700/80 p-1 rounded-2xl backdrop-blur-md shadow-lg overflow-x-auto no-scrollbar">
