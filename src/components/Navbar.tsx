          ...
          <div className="flex items-center justify-between gap-2 sm:gap-4">
            ...
            <div className="flex items-center gap-2 sm:gap-2.5 shrink-0">
              ...
              <button
                ...
                type="button"
                className="btn-uiverse-solid px-3.5 sm:px-5 py-2 text-xs sm:text-sm font-extrabold rounded-xl whitespace-nowrap flex items-center gap-1.5 cursor-pointer shadow-md"
              >
